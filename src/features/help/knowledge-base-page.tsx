    ...
    articles: [
      {
        ...
        content:
          'The Supplier Directory contains all registered suppliers with their profile information, risk ratings, certifications, and performance scores. Use the search and filter options to find suppliers by category, country, or risk level.\n\nTo onboard a new supplier, submit a supplier onboarding request. The onboarding process includes: company registration and documentation, sanctions and compliance screening, financial stability assessment, Third-Party Risk Assessment (TPRA), and contract setup.\n\nAverage onboarding time is 3-4 weeks. The supplier receives portal access during onboarding to upload documents and complete their profile. You can track onboarding progress from the Onboarding Pipeline page.\n\nTip: Before requesting a new supplier, check if an existing approved supplier can meet your needs. Using approved suppliers with existing agreements is faster and often provides better pricing.',
      },
      {
        id: 'sup-2',
        title: 'Supplier risk assessments (TPRA)',
        content:
          'Third-Party Risk Assessments (TPRA) are mandatory for all active suppliers. The assessment covers financial health, regulatory compliance, data protection, ESG performance, and business continuity capabilities.\n\nTPRA validity: Assessments are valid for 24 months. The system automatically flags suppliers with assessments expiring within 90 days. No new purchase orders can be issued against suppliers with expired TPRAs.\n\nRisk ratings: Low (green) indicates minimal risk. Medium (amber) requires monitoring and periodic review. High (red) requires enhanced due diligence and senior management approval. Critical (dark red) may require immediate action or relationship termination.\n\nYou can view TPRA status for any supplier on their profile page under the Risk & Compliance tab. The Supplier Risk Dashboard provides an overview of all suppliers by risk rating.',
      },
    ],
  },
  {
