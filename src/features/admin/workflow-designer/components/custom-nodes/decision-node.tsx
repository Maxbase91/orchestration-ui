...
export function DecisionNode({ data, selected }: NodeProps<DecisionNodeType>) {
  return (
    <div className="relative" style={{ width: 140, height: 140 }}>
      ...
      <div
        className={`absolute inset-0 flex items-center justify-center rounded-lg border-2 bg-warn-soft shadow-sm ${
      ...
      >
        <div className="flex flex-col items-center gap-1" style={{ transform: 'rotate(-45deg)' }}>
          ...
          <span className="text-xs font-semibold text-warn text-center leading-tight" style={{ maxWidth: 70 }}>
            {data.label}
          </span>
        </div>
      </div>
