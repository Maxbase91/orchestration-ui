...
export const widgetRegistry: WidgetConfig[] = [
  ...
  { id: 'expiring-contracts', title: 'Expiring Contracts', description: 'Contracts in their renewal window, soonest first', icon: 'FileWarning', size: 'small', availableTo: allInternal },
