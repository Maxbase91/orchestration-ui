...
export const complianceReports: ComplianceReport[] = [
  // 1 — REQ-2024-0001 (completed, cloud hosting) — approved
  {
    ...
    checks: [
      ...
      { id: 'CHK-001-4', category: 'Supplier Compliance', check: 'TPRA status', status: 'pass', detail: 'TPRA valid until 2025-12-15. Supplier fully assessed.', severity: 'high' },
  ...
  // 2 — REQ-2024-0002 (completed, SAP renewal) — approved
  {
    ...
    checks: [
      ...
      { id: 'CHK-002-3', category: 'Supplier Compliance', check: 'TPRA status', status: 'pass', detail: 'TPRA valid until 2026-06-30. SAP SE fully compliant.', severity: 'high' },
  ...
  // 3 — REQ-2024-0003 (payment, office furniture) — approved
  {
    ...
    checks: [
      ...
      { id: 'CHK-003-3', category: 'Supplier Compliance', check: 'TPRA status', status: 'pass', detail: 'TPRA valid until 2025-09-30. Supplier compliant.', severity: 'high' },
  ...
  // 4 — REQ-2024-0004 (completed, marketing agency) — approved
  {
    ...
    checks: [
      ...
      { id: 'CHK-004-3', category: 'Supplier Compliance', check: 'TPRA status', status: 'pass', detail: 'TPRA valid until 2025-11-20. WPP Group assessed.', severity: 'high' },
  ...
  // 5 — REQ-2024-0005 (completed, security audit) — approved
  {
    ...
    checks: [
      ...
      { id: 'CHK-005-3', category: 'Supplier Compliance', check: 'TPRA status', status: 'pass', detail: 'TPRA valid until 2025-08-15. Deloitte fully assessed and cleared.', severity: 'high' },
  ...
  // 6 — REQ-2024-0016 (po, laptop refresh) — approved
  {
    ...
    checks: [
      ...
      { id: 'CHK-006-4', category: 'Supplier Compliance', check: 'TPRA status', status: 'pass', detail: 'TPRA valid until 2026-01-31. Supplier fully compliant.', severity: 'high' },
  ...
  // 7 — REQ-2024-0017 (invoice, KPMG tax advisory) — needs-review
  {
    ...
    checks: [
      ...
      { id: 'CHK-007-3', category: 'Supplier Compliance', check: 'TPRA status', status: 'pass', detail: 'TPRA valid until 2025-10-01. KPMG fully assessed.', severity: 'high' },
  ...
  // 8 — REQ-2024-0018 (receipt, records management) — approved
  {
    ...
    checks: [
      ...
      { id: 'CHK-008-3', category: 'Supplier Compliance', check: 'TPRA status', status: 'pass', detail: 'TPRA valid until 2025-09-30. Supplier compliant.', severity: 'high' },
  ...
  // 9 — REQ-2024-0024 (po, Hays finance temp staff) — needs-review
  {
    ...
    summary: 'Contingent labour request mostly compliant but flagged for review. Urgency noted — framework call-off valid but TPRA expiring soon.',
    checks: [
      ...
      { id: 'CHK-009-3', category: 'Supplier Compliance', check: 'TPRA status', status: 'warning', detail: 'TPRA expiring in 45 days (2025-02-25). Renewal should be initiated.', severity: 'high' },
    ...
    recommendation: 'TPRA renewal should be initiated in parallel. Urgent request justified — recommend proceeding with PO while flagging TPRA renewal to supplier management.',
  },
  ...
  // 10 — REQ-2024-0033 (receipt, Randstad IT helpdesk) — rejected
  {
    ...
    checks: [
      ...
      { id: 'CHK-010-4', category: 'Supplier Compliance', check: 'TPRA status', status: 'fail', detail: 'TPRA expired on 2024-10-15. Supplier assessment renewal overdue.', severity: 'critical' },
    ...
    recommendation: 'Cannot proceed. TPRA renewal required and sanctions screening flag must be resolved. Escalate to supplier management and compliance teams before re-submission.',
  },
];
