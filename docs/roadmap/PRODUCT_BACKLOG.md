...
| 2.1.2 | As a **Requester**, I want each option in language I understand with a rough timeline. | Each option shows a plain headline and detail — written on the workflow template that claims the channel (Admin → Workflows, `channelCopy`) — plus the category SLA in days. | 🟢 |
