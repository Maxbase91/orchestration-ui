...
| TC-UI-06 | Operational home dashboard (`npm run test:home-designs`) | `/` renders one consistent Expert dashboard with live role-based widgets and quick actions. The retired Apple-style home-design switcher is absent, preventing inconsistent layouts. 0 console errors. |
