...
| runtime | unknown | console | Failed to load resource: the server responded with a status of 405 () | FAILED |  |
| runtime | unknown | console | Failed to load resource: the server responded with a status of 405 () | FAILED |  |
...
| route-sweep | supplier | route | /portal | FAILED |  |
| route-sweep | supplier | route | /portal/sourcing | FAILED |  |
| route-sweep | supplier | route | /portal/invoices | FAILED |  |
| route-sweep | supplier | route | /portal/documents | FAILED |  |
| route-sweep | supplier | route | /portal/messages | FAILED |  |
| catalogue | requester | simple-checkout | fill/review | FAILED |  |
| catalogue | requester | expert-checkout | fill/review | FAILED |  |
| responsive | requester | 320px | open home | OBSERVED | [image](026-responsive-requester-320px.png) |
| responsive | requester | 375px | open home | OBSERVED | [image](027-responsive-requester-375px.png) |
