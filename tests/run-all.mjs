...
const BROWSER = new Set([
  ...
  'test:approval-chains-ui', 'test:form-builder-ui', 'test:approvals-ui',
  'test:dashboard-widget-states', 'test:request-list-ui',
  'test:supplier-evidence-ui', 'test:workflows-board-ui',
]);
