...
check('the intake screens resolve against the configured book',
  ['src/features/requests/new-request/conversation/intake-conversation.tsx', 'src/features/requests/new-request/conversation/use-service-description-conversation.ts']
