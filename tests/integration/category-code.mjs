...
check('the intake screens resolve against the configured book',
  ['src/features/requests/new-request/step-category.tsx', 'src/features/requests/new-request/step-details.tsx', 'src/features/requests/new-request/step-chat-intake.tsx']
